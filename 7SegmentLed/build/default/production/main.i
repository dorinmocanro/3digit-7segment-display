...
disp_test(){
    ...
    send_digit(c_symbol); c_symbol=(c_symbol <<1) | (c_symbol >>7) ;
    _delay((unsigned long)((500)*(8000000/4000.0)));


    send_digit(0xff); _delay((unsigned long)((20)*(8000000/4000.0)));
...
void enumerate_symbols(){
    ...
    while (1) {
        ...
        send_digit(character_table(c++)); _delay((unsigned long)((50)*(8000000/4000.0)));
    }
}
...
void display3(char* data3){
    for(unsigned char bit=0x20 ; bit!=0x01 ; ) {
...
int main(int argc, char** argv) {
    ...
    send_digit(character_table(*my_pointer));_delay((unsigned long)((50)*(8000000/4000.0)));my_pointer++;
    send_digit(character_table((strlen(my_string)+'0'))); _delay((unsigned long)((500)*(8000000/4000.0)));
    send_digit(character_table(*my_pointer));_delay((unsigned long)((50)*(8000000/4000.0)));my_pointer++;
    send_digit(character_table(*my_pointer));_delay((unsigned long)((50)*(8000000/4000.0)));my_pointer++;
